package com.whisperyao.dsplayer.chromecast;
...
public interface IChromeCastService extends IInterface {
    public static String DESCRIPTOR = "com.synology.dsaudio.chromecast.IChromeCastService";

    class Default implements IChromeCastService {
        ...
        @Override
        public boolean canOperate() throws RemoteException {
            return false;
        }
    ...
    boolean canOperate() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IChromeCastService {
        static final int TRANSACTION_canOperate = 32;
        static final int TRANSACTION_clearQueue = 27;
        static final int TRANSACTION_close = 33;
        ...
        static final int TRANSACTION_queueInitiated = 34;
        ...
        static final int TRANSACTION_setVolume = 29;
        ...
        public Stub() {
            attachInterface(this, IChromeCastService.DESCRIPTOR);
        }

        public static IChromeCastService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = obj.queryLocalInterface(IChromeCastService.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IChromeCastService)) {
                return (IChromeCastService) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IChromeCastService.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(IChromeCastService.DESCRIPTOR);
                return true;
            }
            switch (i) {
                case 1:
                ...
                case 31:
                    ...
                    return true;
                case 32:
                    boolean zCanOperate = canOperate();
                    parcel2.writeNoException();
                    parcel2.writeInt(zCanOperate ? 1 : 0);
                    return true;
                case 33:
                    close();
                    parcel2.writeNoException();
        ...
        private static class Proxy implements IChromeCastService {
            ...
            public String getInterfaceDescriptor() {
                return IChromeCastService.DESCRIPTOR;
            }
            ...
            public int getQueuePosition() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IChromeCastService.DESCRIPTOR);
